...
void __fastcall TForm6::Button2Click(TObject *Sender) {
	if (Form3->PropNum == 99) {
		...
		* Form3->PanelH;
		...
		if (Form3->IsRecommend) // ≈сли мы в рекомендаци€х ,то смотрим на ккалории и задаем панели цвет
		{
...
void __fastcall TForm6::Button4Click(TObject *Sender) // удал€ем meals
{
