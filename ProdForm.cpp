...
Form2->Panels[n]->Top=(Form2->ProductsA-1)*Form2->PanelH;
...
Form2->Labeles[(n-1)*4]=new TLabel(Form2);
Form2->Labeles[(n-1)*4]->Parent=Form2->Panels[n];
Form2->Labeles[(n-1)*4]->Top=40;
Form2->Labeles[(n-1)*4]->Left=10;
Form2->Labeles[(n-1)*4]->WordWrap=true;
Form2->Labeles[(n-1)*4]->AutoSize=false;
Form2->Labeles[(n-1)*4]->Height=50;
Form2->Labeles[(n-1)*4]->Width=130;
Form2->Labeles[(n-1)*4]->Font->Size=14;
Form2->Labeles[(n-1)*4]->Caption=Edit1->Text;
...
Form2->Edits[n]=new TEdit(Form2);
Form2->Edits[n]->Parent=Form2->Panels[n];
Form2->Edits[n]->Left=277;
Form2->Edits[n]->Height=Form2->PanelH-1;
Form2->Edits[n]->Width=150;
Form2->Edits[n]->AutoSize=false;
Form2->Edits[n]->ReadOnly=true;

Form2->Labeles[(n-1)*4+1]=new TLabel(Form2);
Form2->Labeles[(n-1)*4+1]->Parent=Form2->Panels[n];
Form2->Labeles[(n-1)*4+1]->Top=40;
Form2->Labeles[(n-1)*4+1]->Left=450;
Form2->Labeles[(n-1)*4+1]->WordWrap=true;
Form2->Labeles[(n-1)*4+1]->AutoSize=false;
Form2->Labeles[(n-1)*4+1]->Height=20;
Form2->Labeles[(n-1)*4+1]->Width=50;
Form2->Labeles[(n-1)*4+1]->Font->Size=10;
Form2->Labeles[(n-1)*4+1]->Caption=Edit2->Text;

Form2->Labeles[(n-1)*4+2]=new TLabel(Form2);
Form2->Labeles[(n-1)*4+2]->Parent=Form2->Panels[n];
Form2->Labeles[(n-1)*4+2]->Top=40;
Form2->Labeles[(n-1)*4+2]->Left=573;
Form2->Labeles[(n-1)*4+2]->WordWrap=true;
Form2->Labeles[(n-1)*4+2]->AutoSize=false;
Form2->Labeles[(n-1)*4+2]->Height=20;
Form2->Labeles[(n-1)*4+2]->Width=50;
Form2->Labeles[(n-1)*4+2]->Font->Size=10;
Form2->Labeles[(n-1)*4+2]->Caption=Edit3->Text;

Form2->Labeles[(n-1)*4+3]=new TLabel(Form2);
Form2->Labeles[(n-1)*4+3]->Parent=Form2->Panels[n];
Form2->Labeles[(n-1)*4+3]->Top=40;
Form2->Labeles[(n-1)*4+3]->Left=696;
Form2->Labeles[(n-1)*4+3]->WordWrap=true;
Form2->Labeles[(n-1)*4+3]->AutoSize=false;
Form2->Labeles[(n-1)*4+3]->Height=20;
Form2->Labeles[(n-1)*4+3]->Width=50;
Form2->Labeles[(n-1)*4+3]->Font->Size=10;
Form2->Labeles[(n-1)*4+3]->Caption=Edit4->Text;
